       ...
       <div class="container">
         ...
         <div class="row">
           <div class="col-lg-6 col-md-6">                    
             <h2 class="checkout__title"></h2>
               <div class="row">
                 <div class="col-lg-7">
                   <div class="checkout__input"  id="sign_up_name">
                     <p>이름<span>*</span></p>
                     <input name="username" type="text" id="signUserName" v-model="name"><br>
                   </div>
                 </div>
                 <div class="col-lg-6">
                   <div class="checkout__input"  id="sign_up_ssn">
                     <p>주민등록번호<span>*</span></p>
                     <input name="ssn" type="text" id="signUserssn" v-model="ssn"  maxlength="13" @keyup="getSsnMask(ssn)"
                 ...
                 <div class="col-lg-6">
                   ...
                   <div class="col-lg-6">
                     <div class="checkout__input">
                         <p>비밀번호<span>*</span></p>
                         <input name="pw" type="password" class="signup_pw" v-model="password" maxlength="16" @keyup="passwordValid" >
                   ...
                   <div class="col-lg-6">
                     <div class="checkout__input">
                       ...
                       <input name="pw_check" type="password" class="signup_pw_check" v-model="passwordCheck" maxlength="16" @keyup="passwordCheckValid">
               ...
               <div class="checkout__input">
                   <p>주소<span>*</span></p>
                   <input type="text" name="zipcode" placeholder="우편번호" id="zip_code" v-model="zonecode">
                   <button type="button" class="orderBtn2" @click="openPostcode">우편번호 검색</button>
                   <input type="text" name="adress" placeholder="주소" class="checkout__input_add" id="adress_input" v-model="roadAddress">
                   <input type="text" name="adress_Details" placeholder="상세주소" class="checkout__input_add" id="adress_input_details" v-model="detailAddress">
               </div> 
               <div class="row">
                   <div class="col-lg-6">
                       <div class="checkout__input">
                           <p>전화번호<span>*</span></p>
                           <input type="text" name="phone" v-model="phone" maxlength="13" placeholder="예) 010-0000-0000"  @keyup="getPhoneMask(phone)" >
                       </div>
                   </div>
                   <div class="col-lg-6">
                       <div class="checkout__input">
                 ...
                 <div class="col-lg-4 col-md-6">
                   <div class="allScrollBar">
                     <h5>이용약관 동의<span> (필수)</span></h5>
                     <div class="scrollBar1">
                         <p>제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
                     ...
                     <h5>개인정보 수집 및 이용 동의<span> (필수)</span></h5>
                     <div class="scrollBar1">
                         <p>
                             개인정보처리방침
                     ...
                     <div class="checkout__input__checkbox">
                       <label for="acc-or">
                           ...
                           <input type="checkbox" id="acc-or" name="acc-or">
                           <span class="checkmark"></span>
                       </label>
                     </div>
                     <div class="checkout__input__checkbox">
                       <label for="payment">
                           <span>개인정보 수집 약관에 동의 하시겠습니까?</span>
                     ...
                     <div class="checkout__input__checkbox">
                       <label for="paypal">
                           <span>개인정보 이용 약관에 동의 하시겠습니까?</span>
