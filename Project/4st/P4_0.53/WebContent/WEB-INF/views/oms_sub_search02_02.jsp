...
function dblClickHandler(event, arguments) {
	const cpnCd = arguments[0].cpn_cd;
	const cpnNm = arguments[0].cpn_nm;
	opener.$("#ch_cd").val(cpnCd);
    opener.$("#ch_nm").val(cpnNm);
    console.log(opener);
    
    opener.clear();
    opener.initCtgrList(cpnCd);
 	opener.displayDetailInfo(cpnCd);
//     opener.updateCtgrTypeOptions(cpnCd);	//부모창의 카테고리 세팅 함수 직접 호출
