...
<link rel="stylesheet" type="text/css" href="./resources/css/sub05_03.css" />
			...
			if (obLength == 0) {
				...
				$(data.dvlList).each(function(i, e) {
					...
					$('#ajax_tbody').append('<tr class="row ajaxTr">' +
						...
						'<td class="a_tbody">' + e.cpn_cd + '</td>' +
						'<td class="a_tbody">' + e.cpn_nm + '</td>' +
						'<td class="a_tbody">' + e.cpn_state + '</td>' +
						'<td class="a_tbody">' + e.cpn_biz_no + '</td>' +
						'<td class="a_tbody">' + e.ceo_nm + '</td>' +
						'<td class="a_tbody">' + e.cpn_addr + '</td>' +
						'<td class="a_tbody">' + phoneNumberFormat(e.cpn_tel) + '</td>' +
						'<td class="a_tbody">' + e.mng_nm + '</td>' +
						'<td class="a_tbody">' + phoneNumberFormat(e.mng_hpno) + '</td>' +
						'<td class="a_tbody">' + e.email + '</td>' +
						'<td class="a_tbody">' + e.in_app + '</td>' + 
						'<td class="a_tbody">' + unixTimeFormat(e.reg_date) + '</td>' +
						'</tr>'
					);
				});
				if (prev) {
...
<body>
	...
	<div class="page_div">
		<header>
			<div id="header_title"><p>시스템관리<b class="greater">&gt;</b>배달대행사관리</p></div>
		...
		<section class='div_header'>
			<div class='search_div' onkeyup='onEnterSearch();'>
				...
				<input type ='text' id='cpntype' name='cpntype' value='DELIVERY' hidden />
