...
$(document).ready(function(){
    ...
    grid = new dhx.Grid("grid", {
	    columns: [
	        { maxWidth: 60, id: "rn", header: [{ text: "매장 리스트", colspan: 5, align: "center" }, { text: "순번", align: "center" }] },
	        { id: "cpn_cd", header: ["", { text: "매장코드", align: "center" }] },
	        { id: "cpn_nm", header: ["", { text: "매장명", align: "center" }] },
	        /* { id: "cpn_addr", header: ["", { text: "주소", align: "center" }] }, */
	        { id: "cpn_state", header: ["", { text: "매장상태", align: "center" }] },
	        { id: "cpn_tel", header: ["", { text: "매장번호", align: "center" }],
...
function search_go(num) {
	...
	$.ajax ({
	    ...
	    success: function (data) {
			...
			let obLength = Object.keys(data.tbsView).length;
...
function dblClickHandler(event, arguments) {
	const scd = arguments[0].cpn_cd;
	const snm = arguments[0].cpn_nm;
	...
	<section class='div_header'>
		<div class='search_div' onkeyup='onEnterSearch()'>
			<select class='select_box' id="type">
				<option value='snm'>채널사명</option>
				<option value='scd'>채널코드</option>
