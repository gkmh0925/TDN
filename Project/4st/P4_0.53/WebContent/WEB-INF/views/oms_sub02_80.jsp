...
<!-- <script src="./resources/js/sub02_80.js"></script> -->
...
<body>
	...
	<div class="page_div">
		<header>
			<div id="header_title">상품관리<b class="greater">&gt;</b>플랫폼사별 카테고리 조회</div>
			...
			<div class='search_div' onkeyup='onEnterSearch()'>
				<c:if test="${UserInfo.USER_LV ne 'S'}">
					...
					<div class="search_form" id="snm_form">
						<input class='search_box' type="search" id='snm' name='snm' readonly /><img src="./resources/img/icon_search_hover.png" id='pnm_img' />
						<input type="hidden" id="snmCd">
					</div>
				</c:if>
				<c:choose>
...
$(document).ready(function() {
    ...
    columns: [
        ...
        { id: "ctgr_type", header: [{ text: "카테고리타입", align: "center" }] },    
        { id: "ctgr_type_nm", header: [{ text: "카테고리타입명", align: "center" }] },
        { id: "ch_cd", header: [{ text: "채널사코드", align: "center" }] },
        { id: "cpn_nm", header: [{ text: "채널사명", align: "center" }] },
        { id: "seq", header: [{ text: "정렬순서", align: "center" }] },
        { id: "ctgr_info", header: [{ text: "카테고리설명", align: "center" }] },        
...
function eventHandler(event, arguments) {
	...
	const ch_cd = arguments[0].ch_cd;
	const ctgr_type = arguments[0].ctgr_type;
	
 	let form = document.createElement("form");
	form.target = "_blank";
	form.method = "POST";
	form.action = "categoryList_detail";
	...
	let Inputch_cd = document.createElement("input");
	Inputch_cd.type = "text";
	Inputch_cd.name = "ch_cd";
	Inputch_cd.value = ch_cd;
	
	let Inputc_type = document.createElement("input");
	Inputc_type.type = "text";
	Inputc_type.name = "ctgr_type";
	Inputc_type.value = ctgr_type;
	
	form.appendChild(Inputscd);
	form.appendChild(Inputch_cd);
	form.appendChild(Inputc_type);
