...
<body>
	...
	<div class="page_div">
		<header>
			<div id="header_title">
				정산내역관리<b class="greater">&gt;</b>배달료 부담금 마스터 관리<b class="greater">&gt;</b>배달료 부담금 마스터 등록
			</div>
		...
		<div class='main_div container'>
			<table id="f_table">
				<tr>
					<th colspan='2' class='mtitle'>배달료 부담금 마스터 등록</th>
				</tr>

				<tr>
					<th class='stitle'>적용시작월<p id="emp">*</p></th>
					<td>
				...
				<tr>
					<th class='stitle'>적용종료월<p id="emp">*</p></th>
					<td><input type="text" name="prd_cd" id="prd_cd" autocomplete="off" placeholder="숫자" /></td>
				</tr>
				<tr>
					<th class='stitle'>마스터명<p id="emp">*</p></th>
					<td><input type="text" name="prd_nm" id="prd_nm" autocomplete="off" placeholder="마스터명" /></td>
				</tr>
				<tr>
					<th class='stitle'>마스터타입<p id="emp">*</p></th>
				...
				<tr>
					<th class='stitle'>금액<p id="emp">*</p></th>
